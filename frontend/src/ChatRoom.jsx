  ...
  const [hasAudio, setHasAudio] = useState(false);
    ...
    <p className="text-xl text-white text-center mb-3">{username} (You)</p>
    ...
    <video
      ...
      width={400}
      ref={localVideoRef}
      className={`${!hasVideo ? "opacity-0" : "opacity-100"} transition-opacity`}
    ></video>
    ...
    {!hasAudio && (
      <p className="text-center text-gray-400 mt-1 text-sm">Mic is off 🎙️</p>
    )}
  </div>
